 ...
 *
 * Exporta `abrirModalAlterarSenha()` para ser chamado pelo dropdown do usuário.
 */

import { getCurrentUser, mostrarSucesso, mostrarErro } from './utils.js';
...
export function abrirModalAlterarSenha() {
